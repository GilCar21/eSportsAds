...
export function CreateAdModal() {
    ...
    return (
        <Dialog.Portal>
            ...
            <Dialog.Content className='fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[] shadow-lg shadow-black/25'>
                ...
                <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
                    ...
                    <label className="mt-2 flex gap-2 text-sm item-center">
                        <Checkbox.Root
